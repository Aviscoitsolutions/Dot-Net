        ...
        private void ReadCallback(IAsyncResult ar)
        {
            ...
            if (state.BytesRecieved > 0 && localBuffer != null)
            {
                ...
                if (state.Accepted == false)
                {
                    ...
                    {
                        Logger.Log("Keyword valid. Waiting for data.");
                        state.Accepted = true;
                    }
                    else
                    {
                ...
                else if (state.BytesRecieved >= 19)
                {
                    ...
                    for (int i = position; i < lastposition; i++)
                    {
                        ...
                        if(localBuffer[i] == 13 && localBuffer[i+1] == 10)
                        {
                            ...
                            if (myArray.Length ==37 )
                            {
                                ...
                                string date1 = myArray[5].ToString() + "-" + myArray[6].ToString() + "-" + myArray[7].ToString() + " " + myArray[8].ToString() + ":" + myArray[9].ToString() + ":" + myArray[10].ToString();

                                Console.WriteLine("Date:" + date1.ToString());

                                var sattake = myArray.Skip(11).Take(1).ToArray();
                                string satstring = BitConverter.ToString(sattake).Replace("-", "");
                                decimal satd = (decimal)Int64.Parse(satstring, System.Globalization.NumberStyles.HexNumber);
                                ...
                                Console.WriteLine("Lattitude:" + latd / 1000000);
                                ...
                                Console.WriteLine("Longitude:" + longd / 1000000);
                            ...
                            else if (myArray.Length == 36)
                            {
                                ...
                                string date1 = myArray[4].ToString() + "-" + myArray[5].ToString() + "-" + myArray[6].ToString() + " " + myArray[7].ToString() + ":" + myArray[8].ToString() + ":" + myArray[9].ToString();
