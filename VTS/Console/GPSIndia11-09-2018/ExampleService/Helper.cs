        ...
        public static bool CheckForKeyword(byte[] buffer)
        {
           ...
           // byte[] s = HexConverter.HexToByteArray(buffer);
            ...
            else if (buffer.Length == 36)
            {
                ...
                decimal con = latd / 30000;
                decimal con1 = con / 60;
                Console.WriteLine("Lattitude:" + con1);
                ...
                decimal con2 = longd / 30000;
                decimal con3 = con / 60;
                
                
                Console.WriteLine("Longitude:" + con3);
                ...
                try
                {
                    ...
                    t.latitude = (double)con1;
                    t.longitude = (double)con3;
