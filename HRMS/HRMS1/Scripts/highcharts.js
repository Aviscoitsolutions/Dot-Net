        ...
        r(Q.prototype, {
            ...
            drawChartBox: function () {
                var a = this.options.chart,
                    ...
                    q = this.clipBox,
                    v = "animate";
                f || (this.chartBackground = f = b.rect().addClass("").add(), v = "attr");
                k = a.borderWidth || 0;
                r = k + (a.shadow ? 8 : 0);
                h = {
                    fill: h || "none"
        ...
        E.prototype.applyFixed = function () {
            ...
            u && (this.fixedDiv = a.createElement("div", {
                className: "highcharts-fixed"
                    ...
                    ".highcharts-yaxis", this.inverted ? ".highcharts-xaxis-labels" : ".highcharts-yaxis-labels", ".highcharts-contextbutton", "", ".highcharts-legend", ".highcharts-subtitle", ".highcharts-title"
                ], function (e) {
